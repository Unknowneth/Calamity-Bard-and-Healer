...
{
	public class DryMouth : ScytheItem
	{
		...
		public override void SetDefaults() {
			...
			base.Item.shoot = ModContent.ProjectileType<Projectiles.DryMouth>();
		...
		public override void HoldStyle(Player player, Rectangle itemFrame) => player.itemLocation += new Vector2(-4f, 16f) * player.Directions;
