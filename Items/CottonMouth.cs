...
{
	public class CottonMouth : ScytheItem
	{
		...
		public override void SetDefaults() {
			...
			base.Item.shoot = ModContent.ProjectileType<Projectiles.CottonMouth>();
			base.Item.scale = 1.3f;
		...
		public override void HoldStyle(Player player, Rectangle itemFrame) => player.itemLocation += new Vector2(-6f, 18f) * player.Directions;
