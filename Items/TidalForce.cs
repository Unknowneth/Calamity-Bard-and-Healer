...
{
	public class TidalForce : ScytheItem
	{
		...
		public override void SetDefaults() {
			...
			base.Item.shoot = ModContent.ProjectileType<Projectiles.TidalForce>();
		...
		public override void HoldStyle(Player player, Rectangle itemFrame) => player.itemLocation += new Vector2(-16f, 20f) * player.Directions;
