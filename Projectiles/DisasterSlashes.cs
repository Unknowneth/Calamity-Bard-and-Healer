...
{
	public class DisasterSlashes : ModProjectile
	{
		...
		public override void AI() {
			if(Projectile.ai[0] == 0f && Main.myPlayer == Projectile.owner && Projectile.timeLeft % 3 == 0) {
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			if(ModLoader.TryGetMod("CalamityMod", out Mod calamity)) target.AddBuff(calamity.Find<ModBuff>("VulnerabilityHex").Type, 180);
		}
