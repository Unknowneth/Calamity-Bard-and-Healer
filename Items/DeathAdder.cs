...
namespace CalamityBardHealer.Items
{
	public class DeathAdder : ScytheItem
	{
		...
		public override void SetDefaults() {
			...
			base.Item.shoot = ModContent.ProjectileType<Projectiles.DeathAdder>();
		...
		public override void HoldStyle(Player player, Rectangle itemFrame) => player.itemLocation += new Vector2(-16f, 28f) * player.Directions;
