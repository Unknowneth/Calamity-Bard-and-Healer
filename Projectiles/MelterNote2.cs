...
{
	public class MelterNote2 : BardProjectile
	{
		public override string Texture => "CalamityMod/Projectiles/Magic/MelterNote2";
		...
		public override void SetBardDefaults() {
			base.Projectile.CloneDefaults(ModLoader.GetMod("CalamityMod").Find<ModProjectile>("MelterNote2").Type);
		...
		public override void BardOnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			if(ModLoader.TryGetMod("CalamityMod", out Mod calamity)) target.AddBuff(calamity.Find<ModBuff>("Dragonfire").Type, 60);
			Main.player[base.Projectile.owner].GetModPlayer<ThoriumPlayer>().HealInspiration(2);
		}
