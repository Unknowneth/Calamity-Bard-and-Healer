...
{
	public class WulfrumWeedWacker : ScytheItem
	{
		...
		public override void SetDefaults() {
			...
			base.Item.shoot = ModContent.ProjectileType<Projectiles.WulfrumWeedWacker>();
		...
		public override void AddRecipes() {
			if(ModLoader.TryGetMod("CalamityMod", out Mod calamity)) CreateRecipe().AddIngredient(calamity.Find<ModItem>("WulfrumMetalScrap").Type, 10).AddTile(16).Register();
		}
		public override void HoldStyle(Player player, Rectangle itemFrame) => player.itemLocation += new Vector2(-6f, 12f) * player.Directions;
