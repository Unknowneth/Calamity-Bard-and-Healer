...
{
	public class CherubimSlash : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			float rotation = MathHelper.Pi * (float)Projectile.timeLeft / 60f - base.Projectile.rotation + Main.GlobalTimeWrappedHourly * MathHelper.PiOver4;
